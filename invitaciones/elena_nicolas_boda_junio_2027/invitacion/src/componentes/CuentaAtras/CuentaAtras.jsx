...
const CuentaAtras = () => {
    ...
    // Ceremonia: 12 de junio de 2027 a las 19:00
    const eventDate = useMemo(() => new Date('2027-06-12T19:00:00'), [])
    ...
    return (
        <div className="countdown-card fuente">
            <div className="fecha-destacada">
                ...
                <span className="fecha-dia-numero">12</span>
                <span className="fecha-mes-anio">Junio de 2027</span>
