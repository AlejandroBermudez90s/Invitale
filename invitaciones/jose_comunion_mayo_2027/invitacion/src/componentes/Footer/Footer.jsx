...
const Footer = () => {
    ...
    return (
        <footer className="footer-section">
            ...
            <Pajarito top="18%" duration={24} delay={2} claro />
            <div ref={ref} className={`container text-center stagger ${visible ? 'is-visible' : ''}`}>
                <div className="footer-wreath">
                    <InsigniaSheriff />
                    <span className="footer-monograma" aria-hidden="true">J</span>
                </div>

                <div className="footer-thanks">
                    <h2 className="thanks-title rotulo-juguete">¡Os esperamos!</h2>
                    <p className="thanks-text">
                        Gracias por dedicar un momento a leer nuestra invitación.
                        <br />
                        Vuestra compañía es el mejor regalo para José en este día tan especial.
                    </p>
                </div>
